<?php 
	...
	if($entities = elgg_extract("entities", $vars, false)){
		foreach($entities as $entity){
			...
			$info .= "<br />";
			$info .= elgg_view("output/url", array("href" => "action/friend_request/approve?guid=" . $entity->getGUID(), 
													"text" => elgg_echo("friend_request:approve"), 
													"is_action" => true));
			$info .= "&nbsp;|&nbsp;";
			$info .= elgg_view("output/url", array("href" => "action/friend_request/decline?guid=" . $entity->getGUID(), 

...
if (check_entity_relationship($friend->guid, 'friendrequest', $user->guid)) {
	...
	$buttons[] = elgg_view('output/url', [
		'href' => "action/friend_request/approve?guid={$friend->guid}",
		'text' => elgg_echo('friend_request:approve'),
		'is_action' => true,
		'class' => 'friend-request-button',
	]);
	$buttons[] = elgg_view('output/url', [
		'href' => "action/friend_request/decline?guid={$friend->guid}",
	...
	// sent request
	$buttons[] = elgg_view('output/url', [
		'href' => "action/friend_request/revoke?guid={$friend->guid}",
